...
export class ChatCoordinator {
  ...
  public async handleRuntimeEvent(
    ...
    const messages = {
      ...
      safety_failed:
        "安全介入後の安定状態を確認できませんでした。現在状態を再観測し、成功とは報告せず、Bot自身の観測値と観測時刻を主体付きで短く伝えてください。利用者の体力・空腹・酸素・水中状態は未確認と明示し、停止・再観測・安全な場所への移動など次の安全な処理と未確認範囲を利用者に判断してもらってください。新しい採取や追従は開始しないでください。",
      connection_recovered:
