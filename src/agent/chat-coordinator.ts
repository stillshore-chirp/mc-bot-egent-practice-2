...
export class ChatCoordinator {
  ...
  public async handleRuntimeEvent(
    ...
    const messages = {
      ...
      safety_failed:
        "安全介入後の安定状態を確認できませんでした。Bot自身の観測値と観測時刻を主体付きで、危険の状態、確認できた安全策の試行と作業状態だけを2文以内で伝えてください。利用者の状態は未確認と明示してください。Botは再観測を続け、新しい危険や利用可能な手段が見つかれば安全介入を切り替えます。利用者に細かな行動選択を求めず、新しい採取や追従は開始しないでください。",
      connection_recovered:
