...
const GOAL_ACTION_PATTERN =
  /(?:続け|続行|再開|集め|採取|移動|追従|来|戻|行|向か|探|収納|登録|覚え|記録|記憶|忘れ|帰|ついて|始め|置|掘|作|建築|攻撃|戦|食べ|飲み|拾|捨て|もう一度|もう一回)/u;
...
const AFFIRMATIVE_GOAL_ACTION_PATTERN =
  /(?:続けて|続行して|再開して|再開しよう|やり直して|もう一度(?:やって|試して)|もう一回(?:やって|試して)|集めて|採取して|移動して|追従して|ついてきて|ついて来て|戻ってきて|戻って来て|来て|戻って|帰って|帰還して|行って|向かって|収納して|登録して|覚えて|記録して|記憶して|忘れて|おいで|(?:追従|採取|収集|移動|帰還|収納)を始めて)(?:ください|下さい|ほしい(?:です)?|ね|よ)?$/u;
...
const CONCRETE_ACTION_MARKER_PATTERN =
  /戻|帰|追従|ついて|おいで|来(?:て|ない|なく)|集め|採取|収集|掘|移動|行って|向か|収納|拾|捨|登録|覚え|記録|記憶|忘れ/gu;
